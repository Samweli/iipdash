"""
Educational institution application configuration.

This module defines the configuration for the `education` application by
...
class EducationConfig(AppConfig):
    """
    Configuration class for the `educational institution` application.

    This class provides metadata and default settings for the
    `educational institution` app, including its name, default primary key
    field type, and human-readable verbose name.
    """
