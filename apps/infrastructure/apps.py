...
This module defines the configuration for the `infrastructure` application by
...
class InfrastructureConfig(AppConfig):
    """
    Configuration class for the `infrastructure` application.

    This class provides metadata and default settings for the `infrastructure`
    app, including its name, default primary key field type, and
