...
router.register(r"network-generations", views.NetworkGenerationViewSet, basename="network-generation")
router.register(r"mobile-coverage", views.MobileCoverageViewSet, basename="mobile-coverage")
