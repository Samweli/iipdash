...
__all__ = ["update_exposure_coverage_raster"]


@shared_task()
def update_exposure_coverage_raster(pk):
    """Update exposure coverage raster data saved in the database based on it's GeoTIFF file."""
