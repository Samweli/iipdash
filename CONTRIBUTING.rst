...
iipdash is an open source project and we love to receive
...
code which can be incorporated into iipdash itself.
...
iipdash project has adopted a Code of Conduct that we expect
...
All work on iipdash happens directly on `GitHub`_. Both core team
...
We will do our best to keep the |main branch|_ in good shape, with
...
iipdash follows `semantic versioning`_. We release patch versions
...
By contributing to iipdash, you agree that your contributions will
...
.. _the full text: https://github.com/tehamalab/iipdash/blob/develop/CODE_OF_CONDUCT.rst
.. _GitHub: https://github.com/tehamalab/iipdash

.. |main branch| replace:: ``main`` branch
.. _main branch: https://github.com/tehamalab/iipdash/tree/main

.. |develop branch| replace:: ``develop`` branch
.. _develop branch: https://github.com/tehamalab/iipdash/tree/develop

.. _semantic versioning: http://semver.org/
.. _GitHub Issues: https://github.com/tehamalab/iipdash/issues
.. _filing an issue: https://github.com/tehamalab/iipdash/issues/new
