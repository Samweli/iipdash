...
export const countriesTilesURL =
  settings.API_ROOT + 'administrative/areas/tiles/{z}/{x}/{y}.mvt/?level=1';
export const educationInstitutionsTilesUrl =
  settings.API_ROOT + 'education/institutions/tiles/{z}/{x}/{y}.mvt/';
export const fiberNodesTilesUrl =
  settings.API_ROOT + 'infrastructure/fiber-nodes/tiles/{z}/{x}/{y}.mvt/';
export const areasEducationTilesURL =
  settings.API_ROOT +
  'administrative/areas-education/tiles/{z}/{x}/{y}.mvt/?level=2';
